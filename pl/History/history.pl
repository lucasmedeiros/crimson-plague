...
koboldsCombatDialogue2:-
    ...
    DialOp3 = ["Os kobolds aceitam sua proposta, provavelmente por falta de",
                    "força ou coragem de lutar.","Voce entrega o dinheiro para eles e segue seu caminho."],

    DialOp4 = ["Opção invalida!"].
...
refectoryCavern:-
    ...
    Dial = ["Uma sala larga e quadrada abriga quatro longas mesas de",
            ...
            "suspenso no ar. ",
            "Voce também exerga três kobolds apontando para voce.",
            ""].
